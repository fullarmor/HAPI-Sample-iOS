...
public class HAPIClient : HAPIClientBase
{
    ...
    var ContextObject : AnyObject? = nil; // temporary variable for holding context
    ...
    func UploadNSData(serverUrl: NSURL, nsdata: NSData!, uploadFolder: String!, fileName: String!)
    {
